...
namespace WorkOrder
{
    ...
    {
        public static WorkOrder.WorkOrderResult CallWebService(string WorkOrderType, string SubscriberNo)
        {
            var ret = new WorkOrder.WorkOrderResult();

            if (WorkOrderType == "41") { WorkOrderType = "138"; }
            else if (WorkOrderType == "42") { WorkOrderType = "139"; } 
